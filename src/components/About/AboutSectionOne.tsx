        ...
        <div className="border-b border-body-color/[.15]  dark:border-white/[.15] ">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              ...
              <SectionTitle
                title="Brainspack provide IT Service and IT consultancy"
                paragraph="Shaping The Future of Business With Web."
                mb="44px"
              />
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative mx-auto aspect-[25/24] max-w-[500px] lg:mr-0">
                <Image
                  src="/imagesBrains/resources/notech-more-img-1.jpg"
                  alt="about-image"
                  fill
