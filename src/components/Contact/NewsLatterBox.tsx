  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <div className="flex items-center  text-green-400 ">
        ...
        <span className="text-md ml-1 font-bold ">Contact with us</span>
      </div>
      <h3 className="mb-4 text-4xl font-bold leading-tight text-black dark:text-white">
      ...
      <div className="pl-12 leading-5">
        <div className="mb-3 flex items-center gap-6">
          <div className="flex h-16 w-16 items-center justify-center bg-gray-300 text-green-400 hover:cursor-pointer hover:bg-green-400 hover:text-[#ffff]">
            <svg
          ...
          <div className=" flex flex-col">
            <p className=" pb-1 text-[12px] text-base leading-relaxed text-body-color">
              Have any question?
            </p>
            <Link
              href="tel:9168117671"
            ...
            >
              <span className=" text-black hover:opacity-60">FREE</span>
              +91-9168117671
            </Link>
          </div>
        </div>
        ...
        <div className="mb-3 flex items-center gap-4">
          ...
          <div className="  flex flex-col ">
            ...
            <p className=" inline-block text-base text-body-color duration-300">
              <div>SCF-15, First Floor,</div>
              <div>opposite Bus Stand Road, Sarojini Colony,</div>
              <div>PART-1, Model Town, Yamuna Nagar,</div>
              <div> Haryana 135001</div>
            </p>
          </div>
        </div>
      </div>
