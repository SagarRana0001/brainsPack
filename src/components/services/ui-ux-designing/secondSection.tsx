import { digitalArrayFrontEnd } from "@/app/utils/constant";
      ...
      <div className="container">
        <div className=" border-body-color/[.15]  dark:border-white/[.15] ">
          <div className="flex flex-wrap pt-10">
            {digitalArrayFrontEnd.map((curr, ind) => (
              <>
                <div
                  key={ind}
                  className="flex w-full justify-center pr-4 lg:w-1/4"
                >
                  <div className="relative mb-5 h-[200px] w-[240px] max-w-[300px]  lg:mr-0">
                    <Image
                      src={curr.img}
                      alt="about-image"
                      fill
...
export default DigitalSecondSection;
